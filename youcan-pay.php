 ...
 */
define( 'WC_YOUCAN_PAY_VERSION', '3.0.0' ); // WRCS: DEFINED_VERSION.
...
define('WC_YOUCAN_PAY_ABSPATH', __DIR__ . 'youcan-pay.php/');
	...
	if ( ! isset( $plugin ) ) {
		class WC_YouCanPay {
			...
			public function init() {
				...
				require_once dirname( __FILE__ ) . '/includes/enums/class-wc-youcanpay-gateways-enum.php';
