...
class WC_YouCanPay_Privacy extends WC_Abstract_Privacy
{
    ...
    public function get_privacy_message()
    {
        ...
        return wpautop(
            sprintf(
                __(
                    'By using this extension, you may be storing personal data or sharing data with an external service. <a href="%s/about-us" target="_blank">Learn more about how this works, including what you may want to include in your privacy policy.</a>',
                    'youcan-pay'
                ),
                ...
                $data_to_export[] = [
                    ...
                    'data'        => [
                        [
                            ...
                            'value' => $order->get_meta('_youcanpay_source_id', true)->save(),
                        ],
                    ],
                ];
            }
    ...
    public function order_data_eraser($email_address, $page)
    {
        ...
        foreach ($orders as $order) {
            ...
            [$removed, $retained, $msgs] = $this->maybe_handle_order($order);
    ...
    {
        $youcanpay_source_id = $order->get_meta('_youcanpay_source_id', true);
        ...
        if (!$this->is_retention_expired($order->get_date_created()->getTimestamp())) {
            ...
            return [
                ...
                [
                    sprintf(
                        __(
                            'Order ID %d is less than set retention days. Personal data retained. (YouCan Pay)',
                            'youcan-pay'
                        ),
                        $order->get_id()
                    ),
        ...
        $order->delete_meta_data('_youcanpay_source_id');
